...
public class ThicknessAlongPathPlot {
    ...
    public static void createGraphForFonts(final File fontFolder, final File targetFolder) throws IOException {
    ...
    public static void plotThickness(final File fontClass, File targetFolder) throws IOException {
        for (final File fileEntry : fontClass.listFiles()) {
            ...
            barPlot(graphFile, fontName);
        }
    }

    public static void barPlot(File barChart, String fontName) throws IOException {
        ...
        try {
            System.out.println(barChart.getPath());
